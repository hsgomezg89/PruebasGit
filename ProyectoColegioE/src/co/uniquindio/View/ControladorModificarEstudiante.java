...
public class ControladorModificarEstudiante {
    ...
    void on_click(MouseEvent event) {
    	...
    	if (event.getSource() == boton_Modificar) {
    	  ...
    	  if (!Text_Id.getText().isEmpty() && !Text_nombre.getText().isEmpty() && !Text_Email.getText().isEmpty()) {
    		 ...
    		 if (VerificarIdentificacion(Text_Id.getText()) && VerificarNombre(Text_nombre.getText())&& VerificarApellido(Text_Apellido.getText())&&
 			    ...
 			    if (colegio.actualizarNombreAlumno(id, nombre, apellido, email)) {
 			    	
 			    	alerta = new Alert(AlertType.ERROR);
     		     	alerta.setTitle("");
     				alerta.setContentText("El estudiante ha sido modificado correctamente");
     				alerta.setHeaderText("INFORMACION");
     				alerta.initStyle(StageStyle.UTILITY);
     				alerta.showAndWait();
    		...
    		if (!Text_ID_Buscar.getText().isEmpty()) {
				...
				Text_Id.setText(estudiante.getId());
				Text_nombre.setText(estudiante.getNombre());
				Text_Apellido.setText(estudiante.getApellido());
				Text_Email.setText(estudiante.getMail());
